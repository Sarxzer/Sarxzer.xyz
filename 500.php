...
<body>
    ...
    <p class="text left long error">> Error403 : Internal Server Error</p>
    <p class="text left long error">> the server encountered an unexpected condition</p>
    ...
    <script>
        ...
        simulateTyping('> Internal Server Error', 100, title);
    </script>
</body>
</html>